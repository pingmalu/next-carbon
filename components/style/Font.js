  ...
  <style jsx global>
    {`
      @font-face {
        font-family: 'Iosevka';
        font-display: swap;
        src: url('https://cdn.jsdelivr.net/npm/@typopro/web-iosevka@3.7.5/TypoPRO-iosevka-term-bold.woff')
          format('woff');
        font-weight: 400;
        font-style: normal;
      }
      ...
      @font-face {
        font-family: 'Monoid';
        font-display: swap;
        src: url('https://cdn.jsdelivr.net/npm/@typopro/web-monoid@3.7.5/TypoPRO-Monoid-Regular.woff')
            format('woff2'),
          url('https://cdn.jsdelivr.net/npm/@typopro/web-monoid@3.7.5/TypoPRO-Monoid-Regular.woff')
            format('woff');
        font-weight: 400;
        font-style: normal;
      }
      ...
      @font-face {
        ...
        font-display: swap;
        src: url('https://cdn.jsdelivr.net/npm/@typopro/web-fantasque-sans-mono@3.7.5/TypoPRO-FantasqueSansMono-Regular.woff')
            format('woff2'),
          url('https://cdn.jsdelivr.net/npm/@typopro/web-fantasque-sans-mono@3.7.5/TypoPRO-FantasqueSansMono-Regular.woff')
            format('woff');
        font-weight: 400;
        font-style: normal;
      }
      ...
      @font-face {
        font-family: 'Hack';
        font-display: swap;
        src: url('https://cdn.staticfile.org/hack-font/3.003/web/fonts/hack-regular.woff2')
            format('woff2'),
          url('https://cdn.staticfile.org/hack-font/3.003/web/fonts/hack-regular.woff')
            format('woff');
        font-weight: 400;
        font-style: normal;
      }
